...
export interface BackendCapabilities {
  ...
  /** RFC 0007: whether the backend enforces hard CPU rate caps by throttling (never killing). True on Linux and Windows where their probes pass and on Docker where the daemon supports updates; false elsewhere (macOS). */
